...
본 프로젝트는 데이터 보안과 비용 효율성을 극대화하기 위해 **로컬 LLM(Qwen 2.5)**과 **고성능 공간 데이터베이스(DuckDB)**를 결합한 **온디바이스 GIS 분석 환경**을 구축하는 것을 목표로 합니다. 
...
데이터 처리 효율성과 로컬 추론의 안정성을 위해 다음과 같은 기술 스택을 사용합니다. 
...
이 시스템은 폐쇄망(Air-gapped) 환경에서도 완벽하게 작동하도록 설계되었습니다.   
